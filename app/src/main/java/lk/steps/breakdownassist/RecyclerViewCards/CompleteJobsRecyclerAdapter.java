...
public class CompleteJobsRecyclerAdapter extends RecyclerView.Adapter<CompleteJobsRecyclerAdapter.ViewHolder> {

    static   List<Breakdown> dbList;
    static  Context context;
    public static CompletedJobsFragment.OnItemTouchListener onItemTouchListener;
    public CompleteJobsRecyclerAdapter(Context context, List<Breakdown> dbList, CompletedJobsFragment.OnItemTouchListener onItemTouchListener ){
    ...
    @Override
    public CompleteJobsRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CompleteJobsRecyclerAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(CompleteJobsRecyclerAdapter.context, "you have clicked Row " + getAdapterPosition(), Toast.LENGTH_LONG).show();
        }
