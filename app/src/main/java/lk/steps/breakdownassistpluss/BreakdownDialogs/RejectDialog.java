...
public class RejectDialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_reject_dialog);
                ...
                public void onClick(View v) {
                    if(spinner.getSelectedItemPosition()==0){
                        ...
                        JobChangeStatus jobStatusChangeRec = new JobChangeStatus(breakdown.get_Job_No(),
                                Breakdown.JOB_REJECT, GetSelectedDateTime(getWindow().getDecorView()), obj.English);
                        UpdateJobStatusChange( jobStatusChangeRec, breakdown, Breakdown.JOB_REJECT);
