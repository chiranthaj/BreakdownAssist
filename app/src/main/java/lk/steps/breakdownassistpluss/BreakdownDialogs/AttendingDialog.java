...
public class AttendingDialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_attending_dialog);
            ...
            btnAttending.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    JobChangeStatus jobStatusChangeRec = new JobChangeStatus(breakdown.get_Job_No(),
                            Breakdown.JOB_ATTENDING, GetSelectedDateTime(getWindow().getDecorView()), etComment.getText().toString());
                    UpdateJobStatusChange( jobStatusChangeRec, breakdown, Breakdown.JOB_ATTENDING);
