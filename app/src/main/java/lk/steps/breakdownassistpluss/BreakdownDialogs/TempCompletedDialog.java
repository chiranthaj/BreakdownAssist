...
public class TempCompletedDialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_temp_complete_dialog);
                ...
                public void onClick(View v) {
                    if(spinner.getSelectedItemPosition()==0){
                        ...
                        JobChangeStatus jobStatusChangeRec = new JobChangeStatus(breakdown.get_Job_No(),
                                Breakdown.JOB_TEMPORARY_COMPLETED, GetSelectedDateTime(getWindow().getDecorView()), obj.English);
                        UpdateJobStatusChange( jobStatusChangeRec, breakdown, Breakdown.JOB_TEMPORARY_COMPLETED);
