...
public class VisitedDialog extends AppCompatActivity {
    Breakdown breakdown;
    int position;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.job_visited_dialog);
        ...
        if(bundle != null){
            ...
            FancyButton btnVisited = (FancyButton) findViewById(R.id.btnVisited);
                ...
                public void onClick(View v) {
                    if(spinner.getSelectedItemPosition()==0){
                        ...
                        JobChangeStatus jobStatusChangeRec = new JobChangeStatus(breakdown.get_Job_No(),
                                Breakdown.JOB_VISITED, GetSelectedDateTime(getWindow().getDecorView()), obj.English);
                        UpdateJobStatusChange(jobStatusChangeRec, breakdown, Breakdown.JOB_VISITED);
